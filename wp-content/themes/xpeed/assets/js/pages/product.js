...
//--------------------------------------PRODUCT IMAGE----------------------------------
    ...
    // Khi một radio button được thay đổi


    // Listen for changes in the size, color, and other options
    ...
    function checkRadioSelection() {
        var totalAttributes = $('.product-detail__size-label').length;
        var totalCheckedRadioInputs = $('.product-detail__size input[type="radio"]:checked').length;

        if (totalCheckedRadioInputs == totalAttributes) {
            // Collect selected radio values
            var selectedValues = [];
            $('.product-detail__size input[type="radio"]:checked').each(function() {
...
///-----------------------------------------------------------------
    ...
    //                 if (
    //                     !selectedVariation ||
    //                     !selectedVariation.max_qty ||
    //                     !selectedVariation.min_qty
    //                 ) {
    //                     console.warn("selectedVariation không hợp lệ.");
    //                     return;
    //                 }
    ...
    //         // Đảm bảo rằng giá trị không nhỏ hơn min_qty khi người dùng nhập thủ công
    //         container
    //             .find(".product-detail__quantity-input")
    //             .on("change", function () {
    //                 // Kiểm tra nếu selectedVariation hợp lệ và có max_qty và min_qty
    //                 if (
    //                     !selectedVariation ||
    ...
    //         ];
    //         // Gọi API để thêm sản phẩm vào giỏ hàng
    //         APIHandler.post(BASE_URL + "/wp-json/custom-api/v1/add-to-cart", data)
    //             .done(function (response) {
    //                 Swal.fire({
    //                     icon: "success",
    //                     title: "Sản phẩm đã được thêm vào giỏ hàng",
    ...
    //             if (
    //                 productType == "simple" &&
    //                 currentValue < dataProductSimple.stock_quantity
    //             ) {
    //                 input.val(currentValue + 1);
    //             } else if (
    //                 productType == "variable" &&
    //                 selectedVariation &&
    //                 currentValue < selectedVariation.max_qty
    //             ) {
    //                 input.val(currentValue + 1);
    //             }
    //         });
